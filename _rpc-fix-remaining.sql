...
-- Bug: community_reports has no "reported_id" column
-- Fix: use "reporter_id" instead
-- ============================================================
...
-- Bug: expedition_departures has no "title" column
-- Fix: use expedition_bookings.trek_name instead, with fallback
-- ============================================================
